...
{
    public class GetFreightMovementItemsByIdQuery : IRequest<FreightMovementResource>
    {
        ...
        public class GetFreightMovementItemsByIdQueryHandler : IRequestHandler<GetFreightMovementItemsByIdQuery, FreightMovementResource>
        {
            private readonly ILogger<GetFreightMovementItemsByIdQueryHandler> _logger;
            private readonly TradefactDbContext _context;
            private readonly IDbConnection _connection;

            // Using DI to inject infrastructure persistence Repositories
            public GetFreightMovementItemsByIdQueryHandler(TradefactDbContext context, IDbConnection connection, ILogger<GetFreightMovementItemsByIdQueryHandler> logger)
            {
            ...
            public async Task<FreightMovementResource> Handle(GetFreightMovementItemsByIdQuery request, System.Threading.CancellationToken cancellationToken)
            {
                ...
                string sQuery = @$"
                                    ...
                                    SELECT  FMI.FreightMovementId, FMI.Id [FreightMovementItemId], 
                                            ...
                                            CASE WHEN FMI.Schedule IS NOT NULL THEN 1 ELSE 0 END [IsPOSchedule], FMI.ScheduleId,
