...
{
    public class RedisMemoryCache : TradefactMemoryCache
    {
        ...
        public RedisMemoryCache(IMemoryCache memoryCache, IOptions<PlatformOptions> options
            , ISubscriber bus
            , IOptions<RedisCachingOptions> redisCachingOptions
            , ILoggerFactory loggerFactory
            ) : base(memoryCache, options, loggerFactory)
        {
            _log = loggerFactory?.CreateLogger<RedisMemoryCache>();
            _bus = bus;
