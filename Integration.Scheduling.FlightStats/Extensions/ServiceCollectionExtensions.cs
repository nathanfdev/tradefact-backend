...
namespace Integration.FlightStats
{
    public static class IServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddFlightStatsService(this IServiceCollection services)
        {
            services.AddHttpClient("flightstats", c =>
            {
            ...
            services.AddTransient<IAirSchedulesService, FlightStatsService>();
