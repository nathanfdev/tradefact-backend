...
namespace Infrastructure.Functions.Extensions
{
    ...
    {
        /// <summary>
        /// Converts a local-time DateTime to UTC DateTime based on the specified     timezone. The returned object will
        /// be of UTC DateTimeKind. To be used     when we want to know what's the UTC representation of the time
        ...
        public static DateTime InZone(this DateTime dateTime, string timezone)
        {
            ...
            var utc = asZonedInUtc.ToDateTimeUtc();

            return utc;
        }

        /// <summary>
        /// Converts a non-local-time DateTime to a local-time DateTime based on the     specified timezone. The
        /// returned object will be of Unspecified DateTimeKind     which represents local time agnostic to servers
        /// timezone. To be used when     we want to convert UTC to local time somewhere in the world.
        /// </summary>
