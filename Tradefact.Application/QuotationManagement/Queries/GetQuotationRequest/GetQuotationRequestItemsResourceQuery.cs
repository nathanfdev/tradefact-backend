...
{
    public class GetQuotationRequestItemsResourceQuery : IRequest<QuotationRequestResource>
    {
        public Guid QuotationRequestId { get; set; }
        public Guid OrganisationId { get; set; }
        public OrganisationTypeEnum OrganisationType { get; set; }

        public class GetQuotationRequestResourceQueryHandler : IRequestHandler<GetQuotationRequestItemsResourceQuery, QuotationRequestResource>
        {
            ...
            public async Task<QuotationRequestResource> Handle(GetQuotationRequestItemsResourceQuery request, System.Threading.CancellationToken cancellationToken)
            {
                ...
                result.FreightMovement = await _mediator.Send(new GetFreightMovementItemsByIdQuery
                {
