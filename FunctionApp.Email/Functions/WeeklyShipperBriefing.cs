...
{
    public static class WeeklyShipperBriefing
    {
        [FunctionName("WeeklyShipperBriefing")]
                ...
                using (SqlCommand cmd = new SqlCommand(text, conn))
                {
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            EmailSender.SendSimpleMessage(variables, JsonConvert.SerializeObject(variables), "weeklyshipperbriefing", "Your Weekly Tradefact Update");
                        }
                    }
                    else
                    {
