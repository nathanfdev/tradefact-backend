...
using Tradefact.Api.Infrastructure.Convertors;
using Tradefact.Application.Models;
using Tradefact.Data;

namespace Tradefact.Api.Model.User
{
    /// <summary>
    ...
    public class UserInfo
    {
        ...
        /// <summary>
        /// Organisation id for the user. A unique value to identify the user.
        /// </summary>
        ...
        [JsonProperty("hasCoreOrgData")]
        public bool HasCoreOrgData { get; set; }
        [JsonProperty("userPreferences")]
        public object UserPreferences { get; set; }

        [JsonProperty("genericSKUEnabled")]
        public bool GenericSKUEnabled { get; set; } = false;
