...
namespace Tradefact.Api.Infrastructure.Middleware
{
    ...
    public class ClaimsTransformer : IClaimsTransformation
    {
        ...
        public ClaimsTransformer(IHttpContextAccessor httpContextAccessor, TradefactDbContext context, IMemoryCache memoryCache, IOptions<AppSettings> appSettings, IServiceBusClient serviceBusClient)
        {
            _context = context;
